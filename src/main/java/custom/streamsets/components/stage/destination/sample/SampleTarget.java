 ...
 */
package custom.streamsets.components.stage.destination.sample;

import com.codahale.metrics.Meter;
import custom.streamsets.components.stage.lib.sample.Errors;
...
public abstract class SampleTarget extends BaseTarget {
  ...
  protected List<ConfigIssue> init() {
    ...
    transforamtionMetric = getContext().createMeter("Count of transformations");
